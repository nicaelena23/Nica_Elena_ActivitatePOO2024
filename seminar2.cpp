...
void afisarePointerLaTara(Tara tara) {
...
Tara* citirePointerLaTara() {
	...
	cout << "are iesire la mare? (o-NU; 1-DA)";
...
int main() {
	...
	delete pTara;
	Tara* p2Tara = citirePointerLaTara(); //citire pointeri la tara
	afisarePointerLaTara(p2Tara); //afisare pointeri la tara
